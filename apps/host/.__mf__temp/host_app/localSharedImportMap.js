...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "pinia": async () => {
          let pkg = await import("__mf__virtual/host_app__prebuild__pinia__prebuild__.js");
            return pkg;
        }
      ,
        "vue": async () => {
      ...
      ,
        "vue-router": async () => {
          let pkg = await import("__mf__virtual/host_app__prebuild__vue_mf_2_router__prebuild__.js");
            return pkg;
        }
