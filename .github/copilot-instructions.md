...
- **Composition API**: Use the Composition API with `<script setup>` syntax for all components.
- **TypeScript**: Always use TypeScript for props, events, and state management.
